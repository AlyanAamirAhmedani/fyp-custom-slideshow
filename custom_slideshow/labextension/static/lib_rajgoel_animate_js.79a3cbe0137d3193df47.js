"use strict";
(self["webpackChunkcustom_slideshow"] = self["webpackChunkcustom_slideshow"] || []).push([["lib_rajgoel_animate_js"],{

/***/ "./lib/rajgoel/animate.js":
/*!********************************!*\
  !*** ./lib/rajgoel/animate.js ***!
  \********************************/
...
/* harmony import */ var _node_modules_svgdotjs_svg_js_src_svg_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../node_modules/@svgdotjs/svg.js/src/svg.js */ "./node_modules/@svgdotjs/svg.js/src/svg.js");
/*****************************************************************
...
const initAnimate = function (Reveal) {
    ...
    function setupAnimations(index, container, config) {
        ...
        animatedSVGs.push({
            svg: [...container.querySelectorAll('svg')].map(svg => (0,_node_modules_svgdotjs_svg_js_src_svg_js__WEBPACK_IMPORTED_MODULE_0__["default"])(svg))
        });
                ...
                try {
                    if (setup[i].element) {
                        ...
                        if (formattedElement.includes('mj[')) {
                            formattedElement = formattedElement.replaceAll('mj[', 'g[data-latex=');
                        }
                        var elements = animatedSVGs[index].svg.map(svg => svg.find(formattedElement));
                        if (!elements.length) {
        ...
        animatedSVGs[index].animation = new _node_modules_svgdotjs_svg_js_src_svg_js__WEBPACK_IMPORTED_MODULE_0__["default"].Timeline().persist(true);
            ...
            for (var fragment = 0; fragment < animations.length; fragment++) {
                ...
                for (var i = 0; i < animations[fragment].length; i++) {
                    try {
                        ...
                        //     ').' +
                        //     animations[fragment][i].modifier +
                        //     '(' +
    ...
    function autoPause() {
        ...
        for (var i = 0; i < elements.length; i++) {
            ...
            if (animatedSVGs[index].animation &&
                ...
                var timeout = animatedSVGs[index].animationSchedule[fragment].end -
    ...
    function seek(timestamp) {
        ...
        for (var i = 0; i < elements.length; i++) {
            ...
            if (animatedSVGs[index].animation &&
                animatedSVGs[index].animationSchedule[fragment]) {
                animatedSVGs[index].animation.time(animatedSVGs[index].animationSchedule[fragment].begin +
                    (timestamp || 0));
            }
        }
        if (timer) {
...
function SVG(element, isHTML) {
  return (0,_utils_adopter_js__WEBPACK_IMPORTED_MODULE_1__.makeInstance)(element, isHTML)
}
...
//# sourceMappingURL=lib_rajgoel_animate_js.79a3cbe0137d3193df47.js.map