"use strict";
(self["webpackChunkcustom_slideshow"] = self["webpackChunkcustom_slideshow"] || []).push([["lib_rajgoel_loadcontent_js"],{

/***/ "./lib/rajgoel/loadcontent.js":
/*!************************************!*\
  !*** ./lib/rajgoel/loadcontent.js ***!
  \************************************/
...
window.RevealLoadContent = window.RevealLoadContent || {
    ...
    init: function (deck) {
        function loadExternalContent(filename) {
            return new Promise(function (resolve) {
                ...
                xhr.onreadystatechange = function (filename, xhr) {
                    if (xhr.readyState === 4) {
                        ...
                        if ((xhr.status >= 200 && xhr.status < 300) || xhr.status === 0) {
                            ...
                            let error = 'ERROR: The attempt to fetch ' +
                                filename +
                ...
                try {
                    ...
                    let error = 'Failed to get the external content from file ' +
                        filename +
                        '. Make sure that the presentation and the file are served by a HTTP(S) server and the file can be found there. ' +
                        e;
                    console.error(error);
                    resolve('<div>' + error + '</div>');
                }
        ...
        return new Promise(function (resolve) {
            ...
            deck
                .getRevealElement()
                .querySelectorAll('[data-load]:not([data-loaded])')
            ...
            filenames.forEach(function (filename, i) {
                ...
                function (response) {
                    ...
                    deck
                        .getRevealElement()
                        .querySelectorAll('[data-load="' + filename + '"]:not([data-loaded])')
                        .forEach(function (container, i) {
...
//# sourceMappingURL=lib_rajgoel_loadcontent_js.e923c36a752e11a5cf8a.js.map